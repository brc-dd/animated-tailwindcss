...
import type { CSSBlock, CSSProperties, EntryPoint, KeyValuePair, PluginsConfig } from './types.js'
import { animationUtils, keyframeUtils } from './utilities.js'

export * from './types.js'

export const withAnimations: EntryPoint = (config = {}) => {
  ...
  const plugins: PluginsConfig = [
    ...
    ({ matchUtilities }): void => {
      ...
      matchUtilities({ 'animate-delay': (value) => ({ animationDelay: value }) }, { values: delay })
